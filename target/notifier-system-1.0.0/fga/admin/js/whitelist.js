...
function deleteEntities() {
	...
	var datos= "service=datastore&op=delete&kind=" + kindSelected;
		
	$(entities).each(function(i,check) {
		if (check.checked){
			datos += "&id=" + check.value;
			enviar = true;
		}
	});
...
function newEntity() {
	window.location = "/fga/admin/whitelist-new.html?kind=OAuthDAO";
}